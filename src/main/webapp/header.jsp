...
<div style="border-bottom: thin solid black; padding:20px; text-align: center; background-color: #232b2b;">
	<div style="">
		<img src="https://i.postimg.cc/hvbbqsQm/upgraded-Playlah.png" alt="PLAYLAH-logo" style="width:90px; z-index: 2; position: relative; float: left;">
  		...
  		<img src="https://i.postimg.cc/C5VHtX5Y/rightconsolelogo.png" alt="PLAYLAH-right" style="width:50px; margin-right: 90px">
